...
def add_to_watchlist(user_id, film_id, public=True):
    ...
    Args:
        ...
        public (bool, optional): Whether the entry is visible to other users.
            Defaults to True (community-first; see Comment 4 in pr-response.md).
            Pass False to keep the entry private.
...
def get_watchlist(user_id):
    ...
    Sort order matches get_collection() so both list views behave the same way
    across the app (see Comment 5 in pr-response.md).
